...
result_QueryTerms_Filtered<-result_MyQueryTerms_RatsMice[result_MyQueryTerms_RatsMice$experiment.troubled==FALSE,]
...
setwd("/Users/sophiemensch/BrainDataAlchemyProject")
