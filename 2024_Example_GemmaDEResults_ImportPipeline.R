...
ExperimentIDs<-c("GSE226730","GSE87700","GSE117357","GSE60000","GSE29417","GSE140287","GSE140598","GSE140596","GSE97181","GSE66468","GSE171191","GSE240887","GSE62385")
ExperimentIDs
...
#ResultSet_contrasts2<-ResultSet_contrasts[-c(20:999),-c(11:26)]
#ResultSet_contrasts<-ResultSet_contrasts2
...
ComparisonsOfInterest<-c("GSE226730_SHR")
...
#Changing Baseline
str(DEResults_GSE226730[[1]])
DEResults_GSE226730_v2<-DEResults_GSE226730
DEResults_GSE226730_v2[[1]]<-DEResults_GSE226730_v2[[1]]*(-1)
str(DEResults_GSE226730_v2[[1]])
DEResults_GSE226730<-DEResults_GSE226730_v2
#################

FilteringDEResults_GoodAnnotation(differentials[[13]])
...
ComparisonsOfInterest<-c("GSE240887_Kdm5b")
