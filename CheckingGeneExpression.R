...
Expression<-gemma.R::get_dataset_processed_expression("GSE87700")
str(Expression)
...
Experiments <- c("GSE226730", "GSE87700", "GSE12457", "GSE117357", "GSE60000", "GSE29417", "GSE140287", "GSE140597", "GSE140598", "GSE140596", "GSE97181", "GSE66468", "GSE171191", "GSE240887", "GSE99135", "GSE62385")

for (i in 1:length(Experiments)) {
  print(Experiments[i])
  Expressions <- gemma.R::get_dataset_processed_expression(Experiments[i])
  print(str(Expressions))
  summary_data <- summary(as.matrix(Expressions[,-c(1:4)]))
  print(summary_data)
}
