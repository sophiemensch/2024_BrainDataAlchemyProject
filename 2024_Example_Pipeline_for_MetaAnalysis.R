...
#800ish (install package): if (!require("BiocManager", quietly = TRUE))
...
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="72386", species="Mouse") 

MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="66737", species="Mouse")

MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="691995", species="Rat") 
